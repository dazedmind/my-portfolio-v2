...
function App() {  
  ...
  return (
    <div className="App font-jost bg-neutral-800">
      ...
      <section id='about' className='text-neutral-300 py-10' data-aos="zoom-in-up">
      ...
      <section id='projects' className='pb-10 my-24'>
      ...
      <section id='contact' className='flex flex-col lg:flex-row pb-10 mx-5 sm:mx-20 lg:mx-32 xl:mx-42 2xl:mx-96 gap-10'>
        <Contact />
        <Footer />
      </section>
