    ...
    <div className="App font-chakra bg-neutral-800">
      <nav className="flex justify-between items-center p-8 sm:px-16 bg-neutral-900 text-white fixed top-0 w-full z-10">
        ...
        <ul className="hidden md:flex gap-11 text-xl items-center">
          ...
          <li>
            <a href="#contact" className=' hover:text-mustard hover:underline underline-offset-8'>contact</a>
          </li>
        </ul>
      ...
      <section id='about' className='text-neutral-300 py-10 pb-24'>
      ...
      <section className='pb-32'>
        ...
        <h1 className=' text-neutral-300 text-center text-4xl font-bold pb-5'>#My Skills</h1>
        <Skills/>
        </section>


        <section id='projects' className='pb-24'>
        <h1 className=' text-neutral-300 text-center text-4xl font-bold pb-5 '>#My Projects</h1>
          <Projects/>
        </section>

        <section id='contact'>
        <h1 className=' text-neutral-300 text-center text-4xl font-bold pb-5'>#Connect</h1>
          <Contact />
        </section>
      </section>
