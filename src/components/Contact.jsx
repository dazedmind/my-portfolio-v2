  ...
  return (
    <div className='bg-neutral-900 p-8 lg:w-half rounded-md'>
        ...
        <div className='flex flex-col text-center py-2'>
            <form name='contact' method="POST" data-netlify="true" className='flex flex-col sm:px-12 lg:px-1 xl:px-12 gap-4 align-middle'>
                ...
                <span className='flex flex-col items-center'>
                    <button type="submit" className='bg-mustard rounded-md  px-4 py-1 cursor-pointer'>Send</button>
                </span>
            </form>
        </div>
    </div>
